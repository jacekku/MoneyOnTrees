...
function setupItems() {
    let items = {
        ...
        pine_saplings: new Item("Pine Sapling", 0, images.pine_sapling, Actions.PLANT, 50, 10,"pine"),
        pine_log: new Item("Pine Log", 0, images.pine_log, null, null, 50),
        pine_plank: new Item("Pine Plank", 0, images.pine_plank, null, null, 20),
