...
function setupItems() {
    let items = {
        ...
        oak_saplings: new Item("Oak Sapling", 1, images.oak_sapling, Actions.PLANT, 30, 2,"oak"),
        oak_log: new Item("Oak Log", 0, images.oak_log, null, null, 15),
        oak_plank: new Item("Oak Plank", 0, images.oak_plank, null, null, 10),

        pine_saplings: new Item("Pine Sapling", 0, images.pine_sapling, Actions.PLANT, 1000, 10,"pine"),
